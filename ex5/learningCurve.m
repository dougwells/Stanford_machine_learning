...
for i=1:m
  [theta] = trainLinearReg(X(1:i,:), y(1:i,:), lambda);     % train new theta vector for each sample size(i).
                                                            % NOTE:  Need full J (w/theta penalty) to find thetas

  [Jtrain(i,:), grad] = linearRegCostFunction(X(1:i,:), y(1:i,:), theta, lambdaTrain);  % No theta penalty since thetas already found above
